...
**Netmig (Application)** 
![Netmig (Application)](https://github.com/Netmig/resources-public/blob/blob/master/screenshots/core-app/mainwindow.png)

**Netmig (Admin-Tools)** 
![Netmig (Admin-Tools)](https://github.com/Netmig/resources-public/blob/blob/master/screenshots/core-admin-tools/savings-dashboard.png)
  ...
  <tbody>
    <tr>
      <td valign="top" style="width: 33%; padding: 8px;">
        ...
        1. <a href="https://github.com/Netmig/resources-public/blob/master/installers/installer.bat">Download installer.bat</a><br>
        2. Connect to VPN<br>
      ...
      <td valign="top" style="width: 33%; padding: 8px;">
        ...
        1. <a href="https://github.com/Netmig/resources-public/blob/master/installers/installer.sh">Download installer.sh</a><br>
    ...
    <tr>
      <td valign="top" style="width: 33%; padding: 8px;">
        ...
        1. <a href="https://github.com/Netmig/resources-public/blob/master/installers/netmig-win64-installer.exe">Download netmig-win64-installer.exe</a><br>
        2. Run installer<br>
        3. Choose:<br>
      ...
      <td valign="top" style="width: 33%; padding: 8px;">
        ...
        1. <a href="https://github.com/Netmig/resources-public/blob/master/installers/netmig_1.0.0_all.deb">Download netmig_1.0.0_all.deb</a><br>
...
- [Netmig Setup Guide (Windows/Linux/macOS)](https://github.com/Netmig/resources-public/blob/blob/master/docs/doc-installer-guide.md)
- [Creating and Publishing a Netmig Script](https://github.com/Netmig/resources-public/blob/blob/master/docs/doc-authoring-guide.md)
